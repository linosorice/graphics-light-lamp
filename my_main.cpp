...
GLfloat light_positio_0[] = {0, 0, 0.4, 1};	//1 vuol dire che è una luce posizionale e non a distanza infinita
...
GLfloat second_arm_rotation = 45;
GLfloat lamp_rotation = 45;
